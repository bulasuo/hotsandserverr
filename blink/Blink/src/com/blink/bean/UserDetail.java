...
public class UserDetail implements Serializable {
	...
	public UserDetail(int udId, int udBlinkeds, int udBlinks, byte ud_bodyOdor, int udBreaks, String udDriving, String udEducation, int udHight, String udHometown, byte udLiveparents, String udLocation, String ud_ownCar, byte ud_ownHouse, int ud_replyTopics, int udSalary, String udSettlement, byte udSnore, int udStates, int udTopics, byte udVirgin, int udWeight, int u_id) {
		this.udId = udId;
	...
	public void setUdHight(int udHight) {
		this.udHight = udHight;
	}
